"use client";
// Port of Whatsapp/client/src/components/admin/modals/AddTenantModal.jsx
...
export default function AddTenantModal({ onClose, onAdded }: { onClose: () => void; onAdded: () => void }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError("");
    try {
      await wtmApi.post("/clients", { name, phone });
      onAdded();
      onClose();
    } catch (err) {
